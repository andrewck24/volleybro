...
describe('Player Mongoose Schema', () => {
  ...
  describe('Model Methods', () => {
    ...
    it('findById method should be callable', () => {
      const result = PlayerModel.findById('test-id');
      expect(result).toBeDefined();
    });
    ...
    it('findByIdAndUpdate method should be callable', () => {
      const result = PlayerModel.findByIdAndUpdate('test-id', {
        name: 'Updated',
      });
      expect(result).toBeDefined();
    });

    it('findByIdAndDelete method should be callable', () => {
      const result = PlayerModel.findByIdAndDelete('test-id');
      expect(result).toBeDefined();
    });

...
describe("Header Component", () => {
  ...
  describe("AC1: Initial transparent state", () => {
    ...
    it("should not have glassmorphism effects in initial state", () => {
      ...
      const glassmorphismContainer = screen.getByTestId("header-glassmorphism-container");
  ...
  describe("AC4: Smooth animations", () => {
    ...
    it("should use requestAnimationFrame for optimized scroll handling", () => {
      ...
      expect(mockScrollY.on).toHaveBeenCalledWith("change", expect.any(Function));
  ...
  describe("AC6: Mobile responsive optimization", () => {
    ...
    // AC6.3: Reduced header padding for space optimization
    it("should use reduced padding on mobile", () => {
      render(<Header observerRef={mockObserverRef} />);
      
      const glassmorphismContainer = screen.getByTestId("header-glassmorphism-container");
      
      // Mobile padding should be smaller
      expect(glassmorphismContainer).toHaveClass("px-3", "py-2");
      // Desktop padding applied at md breakpoint
      expect(glassmorphismContainer).toHaveClass("md:px-6", "md:py-4");
    });

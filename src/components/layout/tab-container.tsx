      ...
      <div className="mx-auto w-full max-w-196">
        {TAB_ORDER.map((tab) => (
          <div
            key={tab}
            className={cn(
              "min-h-dvh bg-background pt-[calc(env(safe-area-inset-top)+3rem)] pr-[env(safe-area-inset-right)] pb-[calc(env(safe-area-inset-bottom)+5rem)] pl-[env(safe-area-inset-left)]",

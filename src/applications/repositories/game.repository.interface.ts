import type { Entry, Game, GameSummary } from "@/entities/game";
...
export interface IGameRepository {
  ...
  /** Records one more entry in a set and returns the set's entries. */
  appendEntry(ref: EntryRef, entry: Entry): Promise<Entry[]>;

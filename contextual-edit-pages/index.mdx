...
description: "將 team、player 與 lineup edit flows 重整到語意明確的 route group。"
capabilities: ["team-management/editing","platform/navigation","platform/forms"]
---
...
合併於 [andrewck24/volleybro#304](https://github.com/andrewck24/volleybro/pull/304)。

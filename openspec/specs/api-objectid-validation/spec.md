# api-objectid-validation Specification

## Purpose

TBD - created by archiving change 'api-objectid-guards'. Update Purpose after archive.
...
tests:
  - src/app/api/teams/[teamId]/lineups/__tests__/route.test.ts

...
## 5. Component Layer Boundary Documentation

- [ ] 5.1 Create `docs/architecture.md` with component layer boundary documentation table (`ui/` vs `custom/` vs `{domain}/`) and rule of thumb
- [ ] 5.2 Review whether any other docs need updating based on this change
- [ ] 5.3 Final verification: `npm test && npx tsc --noEmit && npm run lint && npm run build`
...
- PRs carry no AI attribution (no `Co-Authored-By: Claude`, no "generated by Claude"). The same rule on commits is enforced by commitlint's `no-ai-attribution` rule, not by review.

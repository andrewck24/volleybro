...
- Arming unattended execution adds the `agent:ready` label and moves the issue to Todo; the label stays the only thing Symphony reads, and each later status change has one named owner

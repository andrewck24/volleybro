...
description: "將 team routes 遷移至 clean architecture，並統一 domain、wire 與 client 的 identity mapping。"
capabilities: ["team-management/data-access","game-recording/data-access","platform/clean-architecture"]
---

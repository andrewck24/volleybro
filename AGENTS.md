...
Read [`WORKFLOW.md`](WORKFLOW.md) before intake, planning, implementation, review, handoff, or archive work. It is the canonical provider-neutral delivery contract and owns lifecycle sequencing and every human gate; its repository adapters live in `docs/agents/`.

- [`CONTRIBUTING.md`](CONTRIBUTING.md) — how to work in this repository: branches, commits, pull requests, writing, commands, worktrees, Changesets.
